...
## Files Included
- `schema_dump_20250709_231627.sql` - Complete database schema and data
- `policies_backup_20250709_231627.json` - All RLS policies in JSON format
- `backup_manifest_20250709_231627.json` - Backup metadata and verification info
- `README_20250709_231627.md` - This documentation
...
## Version Information
- **Version**: v0.73.7
- **Timestamp**: 20250709_231627
- **Project ID**: rthgzxorsccgeztwaxnt
- **Backup Date**: Wed Jul  9 23:16:27 PDT 2025
